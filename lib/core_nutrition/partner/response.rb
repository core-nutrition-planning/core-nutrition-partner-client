  ...
  module Partner
    class Response < SimpleDelegator
      ...
      def on(*statuses, &block)
        status_code_mapper = CoreNutrition::Partner::Utilities::StatusCodeMapper.new(statuses)
      ...
      def pagination
        if self.resolved_pagination_attributes?
          CoreNutrition::Partner::Models::Pagination.new(self.resolved_pagination_attributes)
        end
      end
