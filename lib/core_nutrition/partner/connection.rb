...
module CoreNutrition
  module Partner
    class Connection < SimpleDelegator
      ...
      #
      # @example
      #   connection = CoreNutrition::Partner::Connection.new(url: 'http://example.com') do |conn|
      #     conn.adapter(CoreNutrition::Partner::Connection.default_adapter)
      #   end
      #
      #   @connection.headers['Authorization'] = "Bearer 1234"
      #
      # @return [CoreNutrition::Partner::Connection] Faraday Connection Delegator
