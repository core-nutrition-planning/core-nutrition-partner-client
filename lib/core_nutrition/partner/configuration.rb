...
module CoreNutrition
  module Partner
    class Configuration
      ...
      #
      # @example
      #   configuration = CoreNutrition::Partner::Configuration.new(access_token: 'abcd')
      #
      ...
      #
      # @return [CoreNutrition::Partner::Configuration] Instance of the object
      #
      def initialize(attributes={})
        self.class.keys.each do |key|
          instance_variable_set(:"@#{key}", (attributes[key] || CoreNutrition::Partner::Configurations::Default.options[key]))
        end
      end
      ...
      # been initialized.
      #
      # @return [CoreNutrition::Partner::Configuration] The configuration instance
      def configure(&block)
        yield(self)
      end
      ...
      # default state
      #
      # @return [CoreNutrition::Partner::Configuration] The configuration with Defaults applied
      def reset!
        self.class.keys.each do |key|
          instance_variable_set(:"@#{key}", CoreNutrition::Partner::Configurations::Default.options[key])
        end
      end
      alias :setup :reset!
    end
