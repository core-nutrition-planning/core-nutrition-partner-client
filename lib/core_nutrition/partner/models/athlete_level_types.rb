  ...
  module Partner
    module Models
      class AthleteLevelTypes
        ...
        # @param params [Hash]
        #
        # @return [CoreNutrition::Partner::Models::AthleteLevelTypes]
        def self.list(params={})
          request = CoreNutrition::Partner::Requests::AthleteLevelTypes.list(params)
        ...
        def self.retrieve(id, params={})
          request = CoreNutrition::Partner::Requests::AthleteLevelTypes.retrieve(id, params)

          request.on(:success) do |resp|
            return CoreNutrition::Partner::Models::AthleteLevelType.new(resp.data_attributes)
          end
        ...
        def internal_collection
          @collection.map { |record| CoreNutrition::Partner::Models::AthleteLevelType.new(record) }
        end
      end
    end
  end
