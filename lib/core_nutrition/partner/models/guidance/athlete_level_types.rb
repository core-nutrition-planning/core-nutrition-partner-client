    ...
    module Models
      module Guidance
        class AthleteLevelTypes
          ...
          # @param params [Hash]
          #
          # @return [CoreNutrition::Partner::Models::Guidance::AthleteLevelTypes]
          def self.list(params={})
            request = CoreNutrition::Partner::Requests::Guidance::AthleteLevelTypes.list(params)
          ...
          # @param params [Hash]
          #
          # @return [CoreNutrition::Partner::Models::Guidance::AthleteLevelType]
          def self.retrieve(id, params={})
            request = CoreNutrition::Partner::Requests::Guidance::AthleteLevelTypes.retrieve(id, params)

            request.on(:success) do |resp|
              return CoreNutrition::Partner::Models::Guidance::AthleteLevelType.new(resp.data_attributes)
            end
          ...
          def internal_collection
            @collection.map { |record| CoreNutrition::Partner::Models::Guidance::AthleteLevelType.new(record) }
          end
        end
      end
    end
