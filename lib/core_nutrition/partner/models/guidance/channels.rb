    ...
    module Models
      module Guidance
        class Channels
          ...
          # @param params [Hash]
          #
          # @return [CoreNutrition::Partner::Models::Guidance::Channels]
          def self.list(params={})
            request = CoreNutrition::Partner::Requests::Guidance::Channels.list(params)
          ...
          # @param params [Hash]
          #
          # @return [CoreNutrition::Partner::Models::Guidance::Channel]
          def self.retrieve(id, params={})
            request = CoreNutrition::Partner::Requests::Guidance::Channels.retrieve(id, params)

            request.on(:success) do |resp|
              return CoreNutrition::Partner::Models::Guidance::Channel.new(resp.data_attributes)
            end
          ...
          def internal_collection
            @collection.map { |record| CoreNutrition::Partner::Models::Guidance::Channel.new(record) }
          end
        end
      end
    end
