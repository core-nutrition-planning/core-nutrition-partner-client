    ...
    module Models
      module Guidance
        class GoalRecords
          ...
          # @param params [Hash]
          #
          # @return [CoreNutrition::Partner::Models::Guidance::GoalRecords]
          def self.list(params={})
            request = CoreNutrition::Partner::Requests::Guidance::GoalRecords.list(params)
          ...
          def self.retrieve(id, params={})
            request = CoreNutrition::Partner::Requests::Guidance::GoalRecords.retrieve(id, params)

            request.on(:success) do |resp|
              return CoreNutrition::Partner::Models::Guidance::GoalRecord.new(resp.data_attributes)
            end
          ...
          def internal_collection
            @collection.map { |record| CoreNutrition::Partner::Models::Guidance::GoalRecord.new(record) }
          end
        end
      end
    end
