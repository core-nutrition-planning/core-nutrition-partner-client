    ...
    module Models
      module Guidance
        class EventTypes
          ...
          # @param params [Hash]
          #
          # @return [CoreNutrition::Partner::Models::Guidance::EventTypes]
          def self.list(params={})
            request = CoreNutrition::Partner::Requests::Guidance::EventTypes.list(params)
          ...
          # @param params [Hash]
          #
          # @return [CoreNutrition::Partner::Models::Guidance::EventType]
          def self.retrieve(id, params={})
            request = CoreNutrition::Partner::Requests::Guidance::EventTypes.retrieve(id, params)

            request.on(:success) do |resp|
              return CoreNutrition::Partner::Models::Guidance::EventType.new(resp.data_attributes)
            end
          ...
          def internal_collection
            @collection.map { |record| CoreNutrition::Partner::Models::Guidance::EventType.new(record) }
          end
        end
      end
    end
