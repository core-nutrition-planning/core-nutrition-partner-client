    ...
    module Models
      module Guidance
        class MassUnitTypes
          ...
          # @param params [Hash]
          #
          # @return [CoreNutrition::Partner::Models::Guidance::MassUnitTypes]
          def self.list(params={})
            request = CoreNutrition::Partner::Requests::Guidance::MassUnitTypes.list(params)
          ...
          def self.retrieve(id, params={})
            request = CoreNutrition::Partner::Requests::Guidance::MassUnitTypes.retrieve(id, params)

            request.on(:success) do |resp|
              return CoreNutrition::Partner::Models::Guidance::MassUnitType.new(resp.data_attributes)
            end
          ...
          def internal_collection
            @collection.map { |record| CoreNutrition::Partner::Models::Guidance::MassUnitType.new(record) }
          end
        end
      end
    end
