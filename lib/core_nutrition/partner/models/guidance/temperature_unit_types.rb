    ...
    module Models
      module Guidance
        class TemperatureUnitTypes
          ...
          # @param params [Hash]
          #
          # @return [CoreNutrition::Partner::Models::Guidance::TemperatureUnitTypes]
          def self.list(params={})
            request = CoreNutrition::Partner::Requests::Guidance::TemperatureUnitTypes.list(params)
          ...
          def self.retrieve(id, params={})
            request = CoreNutrition::Partner::Requests::Guidance::TemperatureUnitTypes.retrieve(id, params)

            request.on(:success) do |resp|
              return CoreNutrition::Partner::Models::Guidance::TemperatureUnitType.new(resp.data_attributes)
            end
          ...
          def internal_collection
            @collection.map { |record| CoreNutrition::Partner::Models::Guidance::TemperatureUnitType.new(record) }
          end
        end
      end
    end
