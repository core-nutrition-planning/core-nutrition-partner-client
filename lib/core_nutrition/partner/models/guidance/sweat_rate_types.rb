    ...
    module Models
      module Guidance
        class SweatRateTypes
          ...
          # @param params [Hash]
          #
          # @return [CoreNutrition::Partner::Models::Guidance::SweatRateTypes]
          def self.list(params={})
            request = CoreNutrition::Partner::Requests::Guidance::SweatRateTypes.list(params)
          ...
          def self.retrieve(id, params={})
            request = CoreNutrition::Partner::Requests::Guidance::SweatRateTypes.retrieve(id, params)

            request.on(:success) do |resp|
              return CoreNutrition::Partner::Models::Guidance::SweatRateType.new(resp.data_attributes)
            end
          ...
          def internal_collection
            @collection.map { |record| CoreNutrition::Partner::Models::Guidance::SweatRateType.new(record) }
          end
        end
      end
    end
