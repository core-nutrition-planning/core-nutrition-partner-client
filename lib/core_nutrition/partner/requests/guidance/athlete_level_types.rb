      ...
      module Guidance
        class AthleteLevelTypes
          ...
          def self.list(params={})
            rel   = CoreNutrition::Partner::Client.rel_for('partner/rels/guidance-athlete-level-types')
          ...
          def self.retrieve(id, params={})
            ...
            rel   = CoreNutrition::Partner::Client.rel_for('partner/rels/guidance-athlete-level-type')
            route = CoreNutrition::Partner::Client.routes.find_by_rel(rel)
