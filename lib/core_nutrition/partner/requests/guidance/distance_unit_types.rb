      ...
      module Guidance
        class DistanceUnitTypes
          ...
          def self.list(params={})
            rel   = CoreNutrition::Partner::Client.rel_for('partner/rels/guidance-distance-unit-types')
          ...
          def self.retrieve(id, params={})
            ...
            rel   = CoreNutrition::Partner::Client.rel_for('partner/rels/guidance-distance-unit-type')
            route = CoreNutrition::Partner::Client.routes.find_by_rel(rel)
