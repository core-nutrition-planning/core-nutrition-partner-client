      ...
      module Guidance
        class SweatRateTypes
          ...
          def self.list(params={})
            rel   = CoreNutrition::Partner::Client.rel_for('partner/rels/guidance-sweat-rate-types')
          ...
          def self.retrieve(id, params={})
            ...
            rel   = CoreNutrition::Partner::Client.rel_for('partner/rels/guidance-sweat-rate-type')
            route = CoreNutrition::Partner::Client.routes.find_by_rel(rel)
