      ...
      module Guidance
        class MassUnitTypes
          ...
          def self.list(params={})
            rel   = CoreNutrition::Partner::Client.rel_for('partner/rels/guidance-mass-unit-types')
          ...
          def self.retrieve(id, params={})
            ...
            rel   = CoreNutrition::Partner::Client.rel_for('partner/rels/guidance-mass-unit-type')
            route = CoreNutrition::Partner::Client.routes.find_by_rel(rel)
