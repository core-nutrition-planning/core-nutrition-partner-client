      ...
      module Guidance
        class TemperatureUnitTypes
          ...
          def self.list(params={})
            rel   = CoreNutrition::Partner::Client.rel_for('partner/rels/guidance-temperature-unit-types')
          ...
          def self.retrieve(id, params={})
            ...
            rel   = CoreNutrition::Partner::Client.rel_for('partner/rels/guidance-temperature-unit-type')
            route = CoreNutrition::Partner::Client.routes.find_by_rel(rel)
